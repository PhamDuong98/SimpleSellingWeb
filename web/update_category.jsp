        ...
        <div id="panelwrap">
            ...
            <div class="center_content">  
                <%
                                    ...
                                    Category category = dao.getCategory(hid);
                ...
                <div id="right_wrap">
                    <div id="right_content">             
                        ...
                        <form action="UpdateCategory?hid=<%= hid %>" method="post">
                        <div id="tab1" class="tabcontent">
                            <h3>Update category</h3>
                            <div class="form">
                                
                                <div class="form_row">
                                    <label hidden>Hid</label>
                                    <input type="text" class="form_input" name="hid" hidden value="<%= hid %>"/>
                                </div>
                                
                                <div class="form_row">
                                    <label>Hname</label>
                                    <input type="text" class="form_input" name="hname"  value="<%= category.getHname() %>"/>
                                </div>

                                <div class="form_row">
                                    <label>Website</label>
                                    <input type="text" class="form_input" name="website" value="<%= category.getWebsite() %>"/>
                                </div>
