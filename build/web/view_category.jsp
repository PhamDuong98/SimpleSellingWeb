                    ...
                    <div id="right_wrap">
                        <div id="right_content">             
                            ...
                            <table id="rounded-corner">
                                ...
                                <tbody>
                                    <tr class="odd">
                                        ...
                                        <td><%= c.getWebsite() %></td>
                                        <td><%= c.getStatus() %></td>
                                        <td><a href="update_category.jsp?hid=<%= c.getHid() %>"><img src="images/edit.png" alt="" title="" border="0" /></a></td>
                                        <td><a href="ChangeStatusCategory?hid=<%= c.getHid() %>&status=<%= c.getStatus() %>"><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
                                    </tr>
                            ...
                            <div class="form_sub_buttons">
                                <a href="insert_category.jsp" class="button green">Insert category</a>                      
                            </div>
