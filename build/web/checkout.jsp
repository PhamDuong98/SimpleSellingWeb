    ...
    <body>
        ...
        <div class="container">
            <div class="account">
                ...
                <h2 class="account-in">Order list</h2>
                <%
                ...
                <table style="text-align: center; border: 1px solid black; border-collapse: collapse">
                            ...
                            <tbody> 
                                <% 
                                    ...
                                    ArrayList<Invoice> listInvoice = dao.getListInvoice();
                                    int i = 0;
                                    for(Map.Entry<String,Item> list : cart.getCartItems().entrySet()) {
                                %>
                                <tr class="odd">
                                    <td> <%= i++ %></td>
                                    <td style="width: 150px"><%= customer.getCname() %></td>
                                    <td style="width: 150px"><%= list.getValue().getProduct().getSname() %></td>
                                    <td style="width: 50px"><%= list.getValue().getQuantity() %></td>
                ...
                <form action="CheckoutServlet" method="post">		
                    ...
                    <input type="submit" value="Chechout"> 
                </form>
            </div>
        </div>
        <!---->
